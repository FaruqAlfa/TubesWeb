...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <a href="insertForm.html">Tambah Karyawan</a>
            <table class="table">
                ...
                ?>
                        <tr>
                            ...
                            <td><?php echo $row['nikKaryawan']; ?></td>
                            <td><?php echo $row['statusKaryawan']; ?></td>
                            <td>
                                <a href="updateForm.php?idKaryawan=<?php echo $row['idKaryawan']; ?>">Edit</a>
                                <a href="delete.php?idKaryawan=<?php echo $row['idKaryawan']; ?>">Hapus</a>
                            </td>
                        </tr>
                <?php
                    }
