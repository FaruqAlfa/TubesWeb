    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="danaKeluar.php">Dana Keluar</a>
                </li>
                <li>
            ...
            <table class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Jumlah Dana Keluar</th>
                ...
                ?>
                        <tr>
                            <td><?php echo $row['idKeluar']; ?></td>
                            <td><?php echo $row['jumlahKeluar']; ?></td>
                            <td><?php echo $row['keterangan']; ?></td>
                            <td><?php echo $row['tanggal']; ?></td>
                            <td>
                                <a href="updateForm.php?idKeluar=<?php echo $row['idKeluar']; ?>">Edit</a>
                                <a href="delete.php?idKeluar=<?php echo $row['idKeluar']; ?>">Hapus</a>
                            </td>
                        </tr>
                <?php
                    }
